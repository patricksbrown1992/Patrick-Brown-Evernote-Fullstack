...
const NoteNewForm = (props) => {
    ...
    return (
        <div className='new-note-modal'>
            ...
            <h5>Title</h5>
            <span>
                <input type="text" value={title} onChange={handleChangeTitle} placeholder='Note Title' />
            </span>
            <h5>Body</h5>
            <span>
                <input type="text" value={body} onChange={handleChangeBody} placeholder='Note Body' />
            </span>
            <br/>
