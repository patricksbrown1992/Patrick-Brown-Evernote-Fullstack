        ...
        return (
            ...
            <div className="left-nav">
                <ul>
                    ...
                    <li><i className="fas fa-star"></i>Shortcuts</li>
                    <li><Link to='/username'><i className="fas fa-sticky-note"></i>All Notes</Link></li>
                    <li><Link to='/notebooks'><i className="fas fa-book"></i>Notebooks</Link></li>
