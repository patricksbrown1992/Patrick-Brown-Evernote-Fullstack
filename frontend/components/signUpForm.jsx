...
const SignUpForm = () => (
    <div className='sign-up-form'>
            ...
            <textarea placeholder = 'email' name="user-name-submitter" cols="50" rows='1'></textarea>
            <textarea placeholder= 'password' name="password-submitter" cols="50" rows="1"></textarea>
